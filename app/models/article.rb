...
class Article < ApplicationRecord
  ...
  # validates :eyecatch_width, numericality: { in: 100..700 }
  ...
  scope :published_yesterday, -> { where(published_at: Time.zone.yesterday.all_day) }
